...
// import { useAllMesssagesQuery, useDeleteMessagesMutation } from "../../redux/features/allMessagesEndPoint";

export default function DeleteMesage() {
    const dispatch = useDispatch();
    const { isOpen, data } = useSelector((state) => state.allCommonModal);

    // const [deletePage, { isLoading: loading }] = useDeleteMessagesMutation();
